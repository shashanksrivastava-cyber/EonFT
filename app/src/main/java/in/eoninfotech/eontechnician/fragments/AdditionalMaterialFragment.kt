    ...
    private fun initView() {
        ...
        binding!!.addAccessory.setOnClickListener(object : android.view.View.OnClickListener {
            override fun onClick(v: android.view.View?) {
                ...
                parent_linear_layout = accRowView!!.findViewById(R.id.parent_linear_layout)
                ...
                acc_delete_button!!.setOnClickListener(object : android.view.View.OnClickListener {
                    override fun onClick(view: android.view.View?) {
                      ...
                      parent_linear_layout!!.removeView(view?.getParent() as android.view.View?)
                        ...
                        EditText ed_value = view1.findViewById(R.id.etQuantity);
                            ...
                            for (ItemList entry : itemList) {
                                if(entry.getName().equalsIgnoreCase(spinner.getSelectedItem().toString())) {
                                    ...
                                    Toast.makeText(getActivity(), ""+vehicletype.toString(), Toast.LENGTH_LONG).show()
                                }
                            }
