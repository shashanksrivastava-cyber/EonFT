...
public class RecyclerViewRecyclerAdapter extends RecyclerView.Adapter<RecyclerViewRecyclerAdapter.ViewHolder> {
    ...
    @Override
    public RecyclerViewRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        this.context = parent.getContext();
        return new ViewHolder(LayoutInflater.from(context)
                .inflate(R.layout.fault_list_items, parent, false));
    }

    @Override
    public void onBindViewHolder(RecyclerViewRecyclerAdapter.ViewHolder holder,int position) {
