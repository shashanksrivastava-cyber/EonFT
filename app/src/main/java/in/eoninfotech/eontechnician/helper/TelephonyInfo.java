...
public final class TelephonyInfo {
    ...
    public static TelephonyInfo getInstance(Context context) {
        ...
        if (telephonyInfo == null) {
            ...
            Log.i("*** imei", telephonyInfo.imsiSIM1);
            ...
            try {
                ...
                try {
                    ...
                    } catch (GeminiMethodNotFoundException e1k) {
            ...
            //telephonyInfo.isSIM2Ready =  telephonyManager.getSimState() == TelephonyManager.SIM_STATE_READY;
            try {
                ...
                try {
                    ...
                    } catch (GeminiMethodNotFoundException e1kk) {
                        //Call here for next manufacturer's predicted method name if you wish
                        e1kk.printStackTrace();
                    }
                    e1.printStackTrace();
                }
            }
