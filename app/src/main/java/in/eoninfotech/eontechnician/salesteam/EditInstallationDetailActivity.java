...
public class EditInstallationDetailActivity extends AppCompatActivity {
    EditText et_duration, et_cust_street_name, et_cust_city, et_cust_office_number, et_cust_district,
            ...
            et_high_count, et_normal_count, et_low_count, et_install_type, et_cust_type;
    RadioGroup rg_battry_voltage, rg_accessory, rg_ignition;
    ...
    String sales_person_name_s,
            ...
            priority_reason = "0",
            remarks_s, date, version,
            ignition_s = "No", high_count_s, normal_count_s, low_count_s, sale_id_intent, intent_order_no;
    TextView txt_date;
    SharedPreferences sharedprefs;
    SharedPreferences.Editor editor;
    String usrname, current_date, s_time, uusername, disgnid = "0";

    ArrayList<ViewEntryResponse> arr_sales_cust_detail = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_installation_detail);
        ...
        et_install_type = (EditText) findViewById(R.id.install_type);
        et_cust_type = (EditText) findViewById(R.id.cust_type);
        txt_date = (TextView) findViewById(R.id.date_sales);
        ...
        try {
            sale_id_intent = getIntent().getStringExtra("sale_id");
            intent_order_no = getIntent().getStringExtra("order");
            Log.i("***sale_id **", sale_id_intent);
            addDetail(sale_id_intent);
        ...
        preview_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(EditInstallationDetailActivity.this, "Select Vehicle Type", Toast.LENGTH_LONG).show();
                    npe.printStackTrace();
                }
                try {
                ...
                if (!client_name_s.equals("")) {
                    ...
                    Toast.makeText(EditInstallationDetailActivity.this, "select client", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void addDetail(String saleid) {
        pDialog = new ProgressDialog(EditInstallationDetailActivity.this);
        pDialog.setMessage("Loading...");
        pDialog.show();
        ApiHolder log_att = ServiceConnection.getClient(version).create(ApiHolder.class);
        Call<UpdateDataResponse> call = log_att.edit_sale_detail(sale_id_intent);
        ...
        call.enqueue(new Callback<UpdateDataResponse>() {
            ...
            public void onResponse(Call<UpdateDataResponse> call, Response<UpdateDataResponse> response) {
                ...
                if (updateDataResponse != null) {
                    if (updateDataResponse.getType() == 1) {
                        arr_sales_cust_detail = updateDataResponse.getEdit_sales_data();

                        int i = 0;
                        try {
                            et_install_type.setText(arr_sales_cust_detail.get(i).getInstall_type());
                            install_type_s= arr_sales_cust_detail.get(i).getInstall_type();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            et_cust_type.setText(arr_sales_cust_detail.get(i).getCust_type());
                            cust_type_s = arr_sales_cust_detail.get(i).getCust_type();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            txt_date.setText(arr_sales_cust_detail.get(i).getDate());
                            date = arr_sales_cust_detail.get(i).getDate();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            et_order_no.setText(arr_sales_cust_detail.get(i).getOrder_no());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            et_duration.setText(arr_sales_cust_detail.get(i).getDuration());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            et_client_nm.setText(arr_sales_cust_detail.get(i).getCust_name());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            et_cust_street_name.setText(arr_sales_cust_detail.get(0).getCust_street_name());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                        ...
                        et_cust_s_name.setText(arr_sales_cust_detail.get(i).getCust_s_name());
                        et_cust_s_number.setText(arr_sales_cust_detail.get(i).getCust_s_number());
                        et_cust_s_id.setText(arr_sales_cust_detail.get(i).getCust_s_id());
                        et_install_street_name.setText(arr_sales_cust_detail.get(i).getInstall_street_name());
                        et_install_city.setText(arr_sales_cust_detail.get(i).getInstall_city());
                        et_install_office_number.setText(arr_sales_cust_detail.get(i).getInstall_office_number());
                        et_install_district.setText(arr_sales_cust_detail.get(i).getInstall_district());
                        et_install_state.setText(arr_sales_cust_detail.get(i).getInstall_state());
                        et_install_pincode.setText(arr_sales_cust_detail.get(i).getInstall_pincode());
                        // et_vehicle_type_other.setText(arr_sales_cust_detail.get(i).getVehicle_type_other());
                        //et_voltage_other.setText(arr_sales_cust_detail.get(i).getVoltage_other());
                        et_vts_quantity.setText(arr_sales_cust_detail.get(i).getVts_quantity());
                        et_drs_quantity.setText(arr_sales_cust_detail.get(i).getDrs_quantity());
                        et_fuel_sensor_quantity.setText(arr_sales_cust_detail.get(i).getFuel_sensor_quantity());
                        et_door_sensor_quantity.setText(arr_sales_cust_detail.get(i).getDoor_sensor_quantity());
                        et_remarks.setText(arr_sales_cust_detail.get(i).getRemarks());

                        try {
                            et_priority_rsn.setText(arr_sales_cust_detail.get(i).getPriority_reason());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            if (arr_sales_cust_detail.get(i).getHigh_count().equals("0")) {

                            } else {
                                et_high_count.setText(arr_sales_cust_detail.get(i).getHigh_count());
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            et_normal_count.setText(arr_sales_cust_detail.get(i).getNormal_count());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            et_low_count.setText(arr_sales_cust_detail.get(i).getLow_count());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        String str = arr_sales_cust_detail.get(i).getVehicle_type();
                        if (str.contains("car")) {
                        ...
                        if (str.contains("lcv")) {
                            rb_lcv.setChecked(true);
                        }
                        if (str.contains("truck")) {
                            rb_truck.setChecked(true);
                        }
                        if (str.contains("tipper")) {
                            rb_tipper.setChecked(true);
                        }
                        if (str.contains("tm")) {
                            rb_tm.setChecked(true);
                        }
                        if (!str.contains("car") || !str.contains("bus") || !str.contains("lcv") || !str.contains("truck") || !str.contains("tipper") || !str.contains("tm")) {
                            rb_others.setChecked(true);
                        }


                        switch (arr_sales_cust_detail.get(i).getBattery_voltage().trim()) {
                            case "12":
                            case "12 Volt":
                                battery_voltage_s = "12 Volt";
                                ((RadioButton) findViewById(R.id.r_12_volt)).setChecked(true);
                                et_voltage_other.setVisibility(View.GONE);
                                break;
                            case "24":
                            case "24 Volt":
                                battery_voltage_s = "24 Volt";
                                ((RadioButton) findViewById(R.id.r_24_volt)).setChecked(true);
                                et_voltage_other.setVisibility(View.GONE);
                                break;
                            case "48":
                            case "48 Volt":
                                battery_voltage_s = "48 Volt";
                                ((RadioButton) findViewById(R.id.r_48_volt)).setChecked(true);
                                et_voltage_other.setVisibility(View.GONE);
                                break;
                            case "other":
                                battery_voltage_s = "other"; //et_voltage_other.getText().toString();
                                ((RadioButton) findViewById(R.id.r_volt_others)).setChecked(true);
                                et_voltage_other.setVisibility(View.VISIBLE);
                                break;
                        }

                        switch (arr_sales_cust_detail.get(i).getAccessory()) {
                            case "Yes":
                                lay_acc_quan.setVisibility(View.VISIBLE);
                                ((RadioButton) findViewById(R.id.r_yes)).setChecked(true);
                                accessory_s = "Yes";
                                break;
                            case "No":
                                lay_acc_quan.setVisibility(View.GONE);
                                ((RadioButton) findViewById(R.id.r_no)).setChecked(true);
                                accessory_s = "No";
                                break;
                        }

                        switch (arr_sales_cust_detail.get(i).getIgnition()) {
                            case "Yes":
                                ((RadioButton) findViewById(R.id.ig_yes)).setChecked(true);
                                ignition_s = "Yes";
                                break;
                            case "No":
                                ((RadioButton) findViewById(R.id.ig_no)).setChecked(true);
                                ignition_s = "No";
                                break;
                        }
            ...
            public void onFailure(Call<UpdateDataResponse> call, Throwable t) {
                t.printStackTrace();
                pDialog.dismiss();
                Toast.makeText(EditInstallationDetailActivity.this, "Try Again-Connection timeout", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent inteer = new Intent(EditInstallationDetailActivity.this, SalesMainActivity.class);
            startActivity(inteer);
            finish();
        } else if (id == R.id.menu_logout) {
            Intent inteer = new Intent(EditInstallationDetailActivity.this, LoginActivity.class);
    ...
    void alertBox(String title, CharSequence msg, int style, int type) {
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(EditInstallationDetailActivity.this, style);
            ...
            builder.setPositiveButton("Billing Information",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog,
                                            int which) {
                            Intent intent = new Intent(EditInstallationDetailActivity.this, BillingDetailActivity.class);
    ...
    void previewBox(String title, ArrayList<String> pre, int style, int type) {
        ...
        builder.setCancelable(false);
        if (type == 0) {
            LayoutInflater inflater = LayoutInflater.from(EditInstallationDetailActivity.this);
            ...
            lv.setAdapter(new EditInstallationDetailActivity.CustomAdp(EditInstallationDetailActivity.this, pre));
    ...
    private void sendDataToServer() {
        ...
        pDialog.show();
        ApiHolder log_att = ServiceConnection.getClient(version).create(ApiHolder.class);
        Call<UpdateDataResponse> call = log_att.update_requirement(sale_id_intent, sales_person_name_s,
                date,
                order_no_s.trim(),
                install_type_s,
                duration_s,
        ...
        call.enqueue(new Callback<UpdateDataResponse>() {
            ...
            public void onResponse(Call<UpdateDataResponse> call, Response<UpdateDataResponse> response) {
                ...
                Log.i("**respnse", " " + response.body());
                if (updateDataResponse != null) {
                    Toast.makeText(EditInstallationDetailActivity.this, updateDataResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    if (updateDataResponse.getType() == 1) {
